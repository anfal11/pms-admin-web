...
const PendingRealTimeCommisionRuleList = ({ setCommisionInfo, commisionInfo, setModal, modal, getRewardTypeName, TableDataLoading, resetData, setReset, pendingRealtimeRuleList, setpendingRealtimeRuleList, campaignRewardType }) => {
    ...
    //         preConfirm: () => {
    //             return useJwt.approveOrRejectRealtimeRule(id, status).then(res => {
    //                 Success(res)
    //                 console.log(res)
    //                 setpendingRealtimeRuleList(pendingRealtimeRuleList.filter(x => x.id !== id))
...
export default PendingRealTimeCommisionRuleList