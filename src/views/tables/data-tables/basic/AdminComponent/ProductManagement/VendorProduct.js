      ...
      cell: row => {
        return (
          <div className='d-flex'>
            <Eye size={15} color='teal' style={{ cursor: 'pointer' }} onClick={(e) => history.push(`/ProductDetails/${row.productid}`)} />&nbsp;&nbsp;&nbsp;&nbsp;
            <Edit size={15} color='teal' style={{ cursor: 'pointer' }} onClick={(e) => history.push(`/EditProduct/${row.productid}`)} />&nbsp;&nbsp;&nbsp;&nbsp;
            {/* <ImageIcon size={15} color='#2bc871' style={{ cursor: 'pointer' }} onClick={(e) => viewOnlyImage(row.productimage)} />&nbsp;&nbsp;&nbsp;&nbsp; */}
            <Layers size={15} color='#2bc871' style={{ cursor: 'pointer' }} onClick={(e) => history.push(`/UpdateProduct/${row.productid}`)} />&nbsp;&nbsp;&nbsp;&nbsp;
...
*/
  ...
  return (
    <Fragment>
      <Button.Ripple className='ml-2 mb-2' color='primary' tag={Link} to='/admin/addNewProduct'>
        <Plus size={15} />
        <span className='align-middle ml-50'>Add new product</span>
      </Button.Ripple>
     
      <Button.Ripple className='ml-2 mb-2' color='primary' tag={Link} to='/category'>
        <Eye size={15} />
        <span className='align-middle ml-50'>Product Category</span>
      </Button.Ripple>
