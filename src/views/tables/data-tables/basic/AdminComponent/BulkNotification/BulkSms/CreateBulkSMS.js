...
const CreateBulkSMS = () => {
    ...
    const onSubmit = (e) => {
        ...
        useJwt.createBulkSMS({ ...userInput, group_id, qouta_id, adRule_id, rule_id, bulk_sms_file: File}).then((response) => {
            console.log(response)
            setPointRuleloading(false)
            Success(response)
            history.push('/allBulkSMS')
        }).catch((error) => {
            setPointRuleloading(false)
            console.log(error)
            Error(error)
        ...
        <Fragment>
            {
                ...
                </Button.Ripple> : <Button.Ripple className='mb-1' color='primary' tag={Link} to='/allBulkSMS' >
                    <div className='d-flex align-items-center'>
                        <ChevronLeft size={17} style={{ marginRight: '5px' }} />
                        <span >Back</span>
                    </div>
            ...
            <Card>
                <CardHeader className='border-bottom'>
                    <CardTitle tag='h4'>Create Bulk SMS</CardTitle>
                </CardHeader>
                <CardBody style={{ paddingTop: '15px' }}>
                    <Form className="row" style={{ width: '100%' }} onSubmit={onSubmit} autoComplete="off">
                        ...
                        <Col sm='12'>
                            ...
                            <UploadFile handleFile={handleFile} setcustomcodecsvurl={setFile}/>
