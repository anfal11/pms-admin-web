...
const CreateDatapack = () => {
    ...
    const [group_item, setGroup_item] = useState([])
    ...
    useEffect(() => {
        useJwt.operatorList()
            .then((res) => {
                console.log('operatorList ', res.data)
                const options = res.data.payload.map((operator) => ({
                    value: operator.operator_keyword,
    ...
    const onSubmit = (e) => {
        ...
        useJwt.datapackGroupCreate(body).then((res) => {
    ...
    return (
        <Fragment>
            ...
            <Form style={{ width: '100%' }} onSubmit={onSubmit} autoComplete="off">
                <Card>
                    <CardHeader>
                        <CardTitle>Create Datapack Group</CardTitle>
                    </CardHeader>
                    <CardBody>
                        <Row>
                            <Col md='4'>
