...
const pendingGroupContactListView = ({toggleGroupContactListView, groupInfo}) => {
    ...
    const getData = (page, limit) => {
        ...
        useJwt2.pendingGetContactList(page, limit, groupInfo.id).then(res => {
...
export default pendingGroupContactListView