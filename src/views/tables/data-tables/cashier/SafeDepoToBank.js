...
const SafeDepoToBank = () => {
    ...
    const onsubmit = (e) => {
        ...
        // console.log({ deposit_amount: Number(searchValue), from_id: 2, to_id: 3, ip })
        useJwt.submitDeposit({
            ...
            Success(res)
            const { current_balance, deposit_amount, till_balance, till_id, username, id } = res.data.payload
            const newObj = {
                id,
        ...
        <>
            <Card className="py-0 px-1">
                <CardHeader className='border-bottom'>
                    <CardTitle tag='h4'>Safe Deposit to Bank</CardTitle>
                </CardHeader>
                    ...
                    <Row>
                        ...
                        <Col md='4'>
                            ...
                            {/* <Input
                                ...
                                type='text'
                                id='search-input'
                                value={`${window.CURRENCY_SYMBOL} ${till}`}
                            /> */}
                        </Col>
                    </Row>
                </Form>
