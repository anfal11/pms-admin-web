...
const CreateComplain = () => {
    ...
    const onSubmit = async (e) => {
        ...
        await useJwt.singleFileupload(formData)
            .then(res => {
                console.log(res)
                image_url = res.data.payload.image_url
            }).catch(err => {
        ...
        <Fragment>
            ...
            <Card>
                ...
                <CardBody style={{ paddingTop: '15px' }}>
                    ...
                    <Col sm="4" >
                            <FormGroup>
                                <Label for="ruleProvider">Complain Category<span style={{color:'red'}}>*</span></Label>
                                <Select
                    ...
                    <Col sm="4" >
                            <FormGroup>
                                <Label for="ruleProvider">Priority<span style={{color:'red'}}>*</span></Label>
                                <Select
                                    theme={selectThemeColors}
                                    maxMenuHeight={200}
                                    className='react-select'
                    ...
                    <Col sm="12" >
                        <FormGroup>
                            <Label for="complain_description">Complain Description<span style={{color:'red'}}>*</span></Label>
                            <Input type="textarea"
