...
import {
    ChevronDown, Share, Printer, FileText, File, Grid, CheckCircle, Plus, MoreVertical, Edit, Archive, Trash, Search, Eye, Lock, ChevronLeft, RefreshCw, ShoppingCart
} from 'react-feather'
import {
...
const OneTimePlanList = () => {
    ...
    const column = [
        ...
        },
        {
            ...
            minWidth: '100px',
            selector: row => {
                return row.has_ads ? <Badge pill color='success' className='badge-center'>
                Yes
        ...
        },
        {
            ...
            minWidth: '170px',
            sortable: true,
            selector: 'google_ads_budget_show'
        },
        {
            name: 'Facebook Ads',
            minWidth: '170px',
            sortable: true,
            selector: 'facebook_ads_budget_show'
        },
        {
            name: 'Notifications',
            minWidth: '100px',
            selector: row => {
                return row.has_notification ? <Badge pill color='success' className='badge-center'>
                Yes
              </Badge> : <Badge pill color='danger' className='badge-center'>
                No
              </Badge> 
        ...
        },
        {
            ...
            minWidth: '120px',
            sortable: true,
            selector: 'email_amount'
        },
        {
            name: 'Push Notifications',
            minWidth: '120px',
            sortable: true,
            selector: 'push_notification_amount'
        },
        {
            name: 'Facebook Posts',
            minWidth: '120px',
            sortable: true,
            selector: 'facebook_post_amount'
        },
        {
            name: 'Instagram Posts',
            minWidth: '120px',
            sortable: true,
            selector: 'instagram_post_amount'
        },
        {
            name: 'Action',
            minWidth: '150px',
...
export default OneTimePlanList