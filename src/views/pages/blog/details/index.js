...
import {
  Bookmark, CornerUpLeft, Facebook, GitHub,
  Gitlab, Linkedin, MessageSquare, Share2, Twitter
} from 'react-feather'
import {
  Badge, Button, Card,
  CardBody, CardImg, CardText, CardTitle, Col, CustomInput, DropdownItem, DropdownMenu, DropdownToggle,
  Form, FormGroup, Input, Media, Row, UncontrolledDropdown
} from 'reactstrap'
